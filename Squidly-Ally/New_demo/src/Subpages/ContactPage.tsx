...
type FormState = {
  name: string; email: string; phone: string; jobTitle: string; users: string; company: string; message: string;
};

const INIT: FormState = { name: "", email: "", phone: "", jobTitle: "", users: "", company: "", message: "" };
                      ...
                      <Field
                          label={
                            <button
                                ...
                                className={[
                                  "transition-colors",
                                  contactMode === "email" ? "text-slate-700" : "text-slate-400",
                                ].join(" ")}
                          ...
                          hint={
                            <button
                                ...
                                className={[
                                  "transition-colors",
                                  contactMode === "phone" ? "text-slate-700" : "text-slate-400",
                                ].join(" ")}
